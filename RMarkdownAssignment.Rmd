...
> Author's name: Theodore Isaac Rubin
[Source of the quote](https://curiosaday.substack.com/p/kindness-is-more-important-than-wisdom)

### My semester

|**Courses number**| _Courses titles_                 |Instructor 
|:-----------------|:---------------------------------|:--------------
|**CS 2311**       | _Data Struc/Algorithms w/Python_ |John Henderson
|**DATA 2401**     | _Data Science I_                 |Katherine Shoemaker
|**MATH 2405**     | _Discrete Mathematical Struct_   |Mukesh Kumar
|**MATH 2421**     | _Differ & Integral Calculus_     |Sergiy Koshkin
|**UHD 2303**      | _University Seminar-Science_     |Mary Parker
